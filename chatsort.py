...
prompt = [
	...
	f"Between attempts the programming language environment will be reset, so each response needs to compile and work correctly on its own, without depending on previous attempts.",
	f"If the assistant believes it has picked the wrong programming language, it would be better to start from scratch trying to solve the problem in a different programming language than attempting to modify a previous attempt.",
	"",
	f"AI: ",
	script,
]
